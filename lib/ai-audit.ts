...
6. Email Body (email_body): Write a highly professional email summarizing the audit. 
- Start with a greeting like: "Hi [Business Name],"
- When mentioning the report, write exactly: "I have prepared a detailed web report with my findings and recommended action plan." (NEVER use the words 'PDF', 'PNG', 'attached', or 'proposal summary'). 
- End the email with exactly this sign-off: "Would you be open to a short consultation to review the priorities? You are also welcome to reply directly to this email with any questions.\n\nBest regards,\nHassan"
