        ...
        <section className="print-section rounded-[2.5rem] border-none shadow-2xl shadow-indigo-900/10 bg-gradient-to-br from-[#0f172a] to-[#1e1b4b] p-6 md:p-14 text-white relative overflow-hidden">
          ...
          <div className="relative z-10">
            ...
            {reportContent.customProposal ? (
              <div 
                className="text-slate-300 leading-relaxed font-light break-words whitespace-pre-wrap [&_ol]:list-decimal [&_ul]:list-disc [&_ol]:ml-5 [&_ul]:ml-5 [&_li]:mb-2 [&_h1]:text-3xl md:[&_h1]:text-5xl [&_h1]:font-black [&_h1]:tracking-tight [&_h1]:leading-tight [&_h1]:text-white [&_h1]:mb-6 [&_h2]:text-2xl [&_h2]:font-bold [&_h2]:text-white [&_h3]:text-xl [&_h3]:font-bold [&_h3]:text-white [&_p]:mb-4 last:[&_p]:mb-0 [&_p:empty]:h-6 [&_strong]:font-bold [&_b]:font-bold [&_em]:italic [&_i]:italic [&_a]:text-blue-400 [&_a]:underline overflow-hidden w-full"
