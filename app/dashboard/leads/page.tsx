                        ...
                        <div className="p-6 lg:p-0 lg:col-span-4 space-y-2 lg:py-4">
                          <div>
                            ...
                            <div className="flex items-center gap-3 mt-2">
                              {lead.instagram && <a href={lead.instagram} target="_blank" rel="noreferrer" className="text-muted-foreground hover:text-pink-600 transition-colors"><InstagramIcon className="h-3.5 w-3.5" /></a>}
                              {lead.facebook && <a href={lead.facebook} target="_blank" rel="noreferrer" className="text-muted-foreground hover:text-blue-600 transition-colors"><FacebookIcon className="h-3.5 w-3.5" /></a>}
                              {lead.twitter && <a href={lead.twitter} target="_blank" rel="noreferrer" className="text-muted-foreground hover:text-sky-500 transition-colors"><TwitterIcon className="h-3.5 w-3.5" /></a>}
                              {lead.linkedin && <a href={lead.linkedin} target="_blank" rel="noreferrer" className="text-muted-foreground hover:text-blue-800 transition-colors"><LinkedinIcon className="h-3.5 w-3.5" /></a>}
                            </div>
                          </div>
