        ...
        <div className="section-container">
          ...
          <div className="grid gap-12 lg:grid-cols-[1fr_1.5fr]">
            <div className="space-y-8">
              <FadeIn>
                <div className="rounded-[2.5rem] bg-ink p-6 sm:p-10 text-white shadow-premium">
                  ...
                  <div className="mt-12 space-y-6">
                    <a 
                      ...
                      target="_blank" 
                      className="group flex items-center justify-between rounded-2xl border border-white/10 bg-white/5 p-4 sm:p-5 transition-all hover:bg-white/10 hover:border-primary"
                    >
                      <div className="flex items-center gap-3 sm:gap-4 overflow-hidden">
                        <div className="flex shrink-0 h-12 w-12 items-center justify-center rounded-xl bg-emerald-500/10 text-emerald-500">
                          <MessageCircle size={24} />
                        </div>
                        <div>
                          <p className="text-xs font-bold uppercase tracking-widest text-slate-400">WhatsApp</p>
                          <p className="text-base sm:text-lg font-bold truncate">Chat with us</p>
                        </div>
                      </div>
                      <ArrowRight size={20} className="shrink-0 ml-2 text-slate-500 transition-transform group-hover:translate-x-1 group-hover:text-primary" />
                    </a>
                    ...
                    >
                      <div className="flex items-center gap-3 sm:gap-4 overflow-hidden">
                        <div className="flex shrink-0 h-12 w-12 items-center justify-center rounded-xl bg-primary/10 text-primary">
                          <Mail size={24} />
                        </div>
                        <div>
                          <p className="text-xs font-bold uppercase tracking-widest text-slate-400">Email</p>
                          <p className="text-base sm:text-lg font-bold break-all sm:break-normal">{email}</p>
                        </div>
                      </div>
                      <ArrowRight size={20} className="shrink-0 ml-2 text-slate-500 transition-transform group-hover:translate-x-1 group-hover:text-primary" />
                    </a>
                    ...
                    >
                      <div className="flex items-center gap-3 sm:gap-4 overflow-hidden">
                        <div className="flex shrink-0 h-12 w-12 items-center justify-center rounded-xl bg-blue-500/10 text-blue-500">
                          <ExternalLink size={24} />
                        </div>
                        <div>
                          <p className="text-xs font-bold uppercase tracking-widest text-slate-400">Freelancer</p>
                          <p className="text-base sm:text-lg font-bold truncate">View Profile</p>
                        </div>
                      </div>
                      <ArrowRight size={20} className="shrink-0 ml-2 text-slate-500 transition-transform group-hover:translate-x-1 group-hover:text-primary" />
                    </a>
              ...
              <FadeIn delay={0.1}>
                <div className="rounded-[2.5rem] border border-black/5 bg-slate-50 p-6 sm:p-10">
